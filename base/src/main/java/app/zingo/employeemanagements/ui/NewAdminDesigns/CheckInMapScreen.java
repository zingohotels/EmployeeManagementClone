...
public class CheckInMapScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            Objects.requireNonNull ( getSupportActionBar ( ) ).setTitle("Map View");
            ...
            mapView.getMapAsync( googleMap -> {
                ...
                try{
                    if(ln!=null){
                        ...
                        if(ln.getLongitude()!=null&&ln.getLatitude()!=null&&ln.getLogoutLatitude ()==null&&ln.getLogoutLongitude ()==null){
                        ...
                        }else if(ln.getLogoutLatitude ()!=null&&ln.getLogoutLongitude ()!=null){
                            markerData.add(new MarkerData (Double.parseDouble(ln.getLogoutLatitude()),Double.parseDouble(ln.getLogoutLongitude()),""+title+" - "+status,ln.getLogoutLocation ()));
                            MarkerPoints.add(new LatLng(Double.parseDouble(ln.getLogoutLatitude()),Double.parseDouble(ln.getLogoutLongitude())));
                        }
                        ...
                        if( markerData.size ( ) != 0 ){
                            ...
                            CameraPosition cameraPosition = new CameraPosition.Builder().zoom(25).target(latlng).build();
