...
public class AllEmployeeLiveLocation extends AppCompatActivity {
   private MapView mapView;
    ...
    private LinearLayout scrollableLay,mMapShow;
    ...
    //Global var
    private ArrayList<LiveTrackingAdminData> listLive;
    private ArrayList<LiveTrackingAdminData> listLives;
    private int listSize = 0,countValue=0;
