...
public class LoginDetailsNotificationManagers  implements Serializable {
    ...
    @SerializedName("LogoutPlaceId")
    private String LogoutPlaceId;
    ...
    public String getLogoutPlaceId ( ) {
        return LogoutPlaceId;
    }
    public void setLogoutPlaceId ( String logoutPlaceId ) {
        LogoutPlaceId = logoutPlaceId;
    }
    public static Comparator getCompareLoginNM ( ) {
        return compareLoginNM;
    }
    public static void setCompareLoginNM ( Comparator compareLoginNM ) {
        LoginDetailsNotificationManagers.compareLoginNM = compareLoginNM;
    }
