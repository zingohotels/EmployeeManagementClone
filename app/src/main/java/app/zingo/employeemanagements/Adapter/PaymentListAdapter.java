...
public class PaymentListAdapter extends RecyclerView.Adapter<PaymentListAdapter.ViewHolder>{
    ...
    class ViewHolder extends RecyclerView.ViewHolder /*implements View.OnClickListener*/ {
        ...
        public ViewHolder(View itemView) {
            ...
            mName = (MyTextView)itemView.findViewById(R.id.payment_name_reseller);
            mAddress = (MyTextView)itemView.findViewById(R.id.organization_address_reseller);
            mDuration = (MyTextView)itemView.findViewById(R.id.organization_time_reseller);
            mAmount = (MyTextView)itemView.findViewById(R.id.organization_amoubt_reseller);
            mCommissionPer = (MyTextView)itemView.findViewById(R.id.commision_price);

            mAppType = (MyTextView)itemView.findViewById(R.id.status);
