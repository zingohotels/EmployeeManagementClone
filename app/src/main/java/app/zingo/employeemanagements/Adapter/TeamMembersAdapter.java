...
public class TeamMembersAdapter extends RecyclerView.Adapter<TeamMembersAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            mEmName = (TextView)itemView.findViewById(R.id.employee_name);
            mLayout = (CardView) itemView.findViewById(R.id.employee);
            mTeamEmLis = (RecyclerView) itemView.findViewById(R.id.team_emp_list);
            mShowList = (ImageView) itemView.findViewById(R.id.shw_emp_list);
