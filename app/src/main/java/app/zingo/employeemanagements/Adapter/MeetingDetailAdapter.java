...
public class MeetingDetailAdapter extends RecyclerView.Adapter<MeetingDetailAdapter.ViewHolder>{
            ...
            holder.mMap.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try{
                        ...
                        MapView mMapView = (MapView) dialog.findViewById(R.id.organization_map);
    ...
    class ViewHolder extends RecyclerView.ViewHolder /*implements View.OnClickListener*/ {
        ...
        public ViewHolder(View itemView) {
            ...
            mEdit = (ImageView) itemView.findViewById(R.id.update);
    ...
    public void updateMeetings(final Meetings tasks, final AlertDialog dialogs) throws Exception{
