...
public class LiveTrackingAdapter extends RecyclerView.Adapter<LiveTrackingAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(liveTrackingArrayList!=null){
            ...
            holder.mupdated.setText("Last updated at : "+liveTrackingArrayList.getTrackingTime());
    ...
    class ViewHolder extends RecyclerView.ViewHolder /*implements View.OnClickListener*/ {
        ...
        public ViewHolder(View itemView) {
            ...
            mEmpName = (TextView) itemView.findViewById(R.id.emp_name_loca);
            mupdated = (TextView) itemView.findViewById(R.id.updated_details);
            mAddress = (TextView) itemView.findViewById(R.id.address);
            mLay = (LinearLayout) itemView.findViewById(R.id.live_lay);
