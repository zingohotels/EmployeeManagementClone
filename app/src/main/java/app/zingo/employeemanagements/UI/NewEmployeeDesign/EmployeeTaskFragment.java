...
//            this.mCalendarDay = CalendarDay.from(new Date());
            this.presentDate = (TextView) layout.findViewById(R.id.presentDate);
            // this.presentDate.setText(DateUtil.getReadableDate(this.mCalendarDay));
            mTaskList = (RecyclerView) layout.findViewById(R.id.targetList);
            ...
            this.floatingActionButton = (FloatingActionButton) layout.findViewById(R.id.addTargetOption);
            totalTargets = (TextView) layout.findViewById(R.id.totalTargets);
            openTargets = (TextView) layout.findViewById(R.id.openTargets);
            closedTargets = (TextView) layout.findViewById(R.id.closedTargets);
            movedTargets = (TextView) layout.findViewById(R.id.movedTargets);

            mPendingTask = (LinearLayout) layout.findViewById(R.id.openTargetsLayout);
            mCompletedTask = (LinearLayout) layout.findViewById(R.id.closedTargetsLayout);
            mClosedTask = (LinearLayout) layout.findViewById(R.id.movedTargetsLayout);
            mTotalTask = (LinearLayout) layout.findViewById(R.id.totalTargetsLayout);
