...
public class ExpenseDashBoardAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            mTotalAmount = (TextView) findViewById(R.id.expense_amount);
            mClaimedAmount = (TextView) findViewById(R.id.claimed_amount);
            mTotalCount = (TextView) findViewById(R.id.total_expenses);
            mApprovedCound = (TextView) findViewById(R.id.approved_expenses);
            mRejectedCount = (TextView) findViewById(R.id.rejected_expenses);
            mPendingCount = (TextView) findViewById(R.id.pending_expenses);
            mPrevious = (ImageView)findViewById(R.id.previousDay);
            mNext = (ImageView)findViewById(R.id.nextDay);
            mExpenseList = (RecyclerView) findViewById(R.id.expenses_list_dash);
            mExpenseList.setLayoutManager(new LinearLayoutManager(ExpenseDashBoardAdmin.this));
            mNoExpensesLay = (LinearLayout) findViewById(R.id.noRecordFound);
