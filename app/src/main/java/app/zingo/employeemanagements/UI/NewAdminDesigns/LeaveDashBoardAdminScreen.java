...
public class LeaveDashBoardAdminScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            mPaidCount = (TextView) findViewById(R.id.paid_leaves);
            mUnpaidCount = (TextView) findViewById(R.id.un_paid_leaves);
            mTotalCount = (TextView) findViewById(R.id.total_leaves);
            mApprovedCound = (TextView) findViewById(R.id.approved_leaves);
            mRejectedCount = (TextView) findViewById(R.id.rejected_leaves);
            mPendingCount = (TextView) findViewById(R.id.pending_leaves);
            mPrevious = (ImageView)findViewById(R.id.previousDay);
            mNext = (ImageView)findViewById(R.id.nextDay);
            mLeaveList = (RecyclerView) findViewById(R.id.leaves_list_dash);
            mLeaveList.setLayoutManager(new LinearLayoutManager(LeaveDashBoardAdminScreen.this));
            mNoLeavesLay = (LinearLayout) findViewById(R.id.noRecordFound);
